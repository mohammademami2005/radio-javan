"use client";
import { PauseCircle, Play } from "iconsax-react";
...
export default function MusicClient({
  ...
  return (
    <main
      className="w-full lg:pr-[20%] h-screen"
      style={{
    ...
    >
      <section className="w-full h-full flex-col flex p-[5%] items-center">
        ...
        <div className="h-1/2 w-[80%] lg:w-[50%] bg-stone-950/25  flex flex-wrap justify-between p-[5%]  *:font-bold *:w-full rounded-2xl *:flex *:justify-between *:gap-5">
          <h3>
